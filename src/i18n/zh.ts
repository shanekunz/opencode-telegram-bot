...
export const zh: I18nDictionary = {
  ...
  "model.search.button": "🔎 搜索模型",
  "model.search.prompt": "请发送模型搜索关键词。",
  "model.search.results_title": "模型搜索结果：{query}",
  "model.search.no_results": "未找到匹配的模型：{query}",
  "model.search.search_again": "🔁 再次搜索",
  "model.search.error": "🔴 搜索模型失败",
  "model.menu.error": "🔴 获取模型列表失败",

  "messages.project_not_selected": "🏗 尚未选择项目。\n\n请先使用 /projects 选择项目。",
  "messages.session_not_selected": "📋 尚未选择会话。请先使用 /sessions 或 /new。",
  "messages.session_project_mismatch": "⚠️ 当前会话属于其他项目。请先选择匹配的会话。",
  "messages.empty": "📭 此会话中没有用户消息。",
  "messages.fetch_error": "🔴 加载会话消息失败。",
  "messages.select": "请选择一条消息：",
  "messages.select_page": "请选择一条消息（第 {page} 页）：",
  "messages.inactive_callback": "此消息菜单已失效",
  "messages.cancelled_callback": "已取消",
  "messages.page_empty_callback": "此页没有消息",
  "messages.button.prev_page": "⬅️ 上一页",
  "messages.button.next_page": "下一页 ➡️",
  "messages.button.revert": "↩️ 回退到这里",
  "messages.button.fork": "🌿 分叉会话",
  "messages.button.back": "⬅️ 返回",
  "messages.button.cancel": "❌ 取消",
  "messages.revert_success": "✅ 已将会话回退到这条消息：\n\n{text}",
  "messages.revert_error": "🔴 会话回退失败。",
  "messages.fork_success": "✅ 已从这条消息分叉出新会话：\n\n{text}",
  "messages.fork_error": "🔴 分叉新会话失败。",
